...
<img src="G:\JavaLearning2023\project2024\images\papi-架构.png" style="zoom:80%;" />
...
![](G:\JavaLearning2023\project2024\images\login&register.png)

### 2 接口发布

您可以 <a href="https://api.papi.icu">Papi 在线开放平台</a> 的发射中心向名为互联网的“星云”发射你超炫酷的接口，与全宇宙的小伙伴一起共享你的创意！

![](G:\JavaLearning2023\project2024\images\add.png)

<img src="G:\JavaLearning2023\project2024\images\add2.png" style="zoom:67%;" />

<img src="G:\JavaLearning2023\project2024\images\add3.png" style="zoom:67%;" />
...
<img src="G:\JavaLearning2023\project2024\images\interface-market.png" style="zoom: 67%;" />

![](G:\JavaLearning2023\project2024\images\QQ截图20240710091557.png)

当然，在您调试前，先了解一下接口的参数、错误码、代码实例也是十分必要的✨

![](G:\JavaLearning2023\project2024\images\tool.png)
...
![](G:\JavaLearning2023\project2024\images\QQ截图20240710135353.png)

此外，papi-client-sdk 已经登陆 **Maven 中心仓库**，只需要在 pom 文件中引入即可快速启动🎉

![](G:\JavaLearning2023\project2024\images\maven-papi.png)
...
![](G:\JavaLearning2023\project2024\images\papi-yml.png)
...
![](G:\JavaLearning2023\project2024\images\QQ截图20240711144449.png)
...
![](G:\JavaLearning2023\project2024\images\image (3).png)![](G:\JavaLearning2023\project2024\images\QQ截图20240304104906.png)

后端准备多个dto

![](G:\JavaLearning2023\project2024\images\image0304.png)
...
![](G:\JavaLearning2023\project2024\images\image (4).png)
...
1. 首先，修改与添加modal大致相同，不同之处在于，修改是有原数据的，所以modal中要传进来值，然后设置表单内的初始值initialValues
   ...
   ![](G:\JavaLearning2023\project2024\images\QQ截图20240306150939.png)
...
3. 在React中用useEffect()来监听数据的变化，注意form要传入proTableRef，这样才能访问到表单实例
   ...
   ![](G:\JavaLearning2023\project2024\images\QQ截图20240307203743.png)

   - 在组件中写的内容会直接显式在页面上

     ![](G:\JavaLearning2023\project2024\images\QQ截图20240307203924.png)
...
4. 在实测时发现报错，提示没有传入id。溯源：用户点击提交，实际上执行了onSubmit，并执行了 handleUpdate()方法，并传进Value的参数，这个参数来自我们的内部组件UpdateModal这个模态窗里用户输入的信息。而UpdateModal模态窗内的columns是由外部定义的，在这些columns 中，我们把id列的属性定义为了index。这样定义的结果是，id列不会出现在表单项里，也就不会被填入表单。
   ...
   ![](G:\JavaLearning2023\project2024\images\QQ截图20240307204606.png)![](G:\JavaLearning2023\project2024\images\QQ截图20240307205223.png)

5. 我们需要保存用户当前点击的数据项的 id，这里有个现成的 **<font color='red'>选中行</font>currentRow**，直接用这个去取id就行了。

   ![](G:\JavaLearning2023\project2024\images\QQ截图20240307205911.png)

   我们在点击修改时执行了选中行和让修改模态框显示

   ![](G:\JavaLearning2023\project2024\images\QQ截图20240307211314.png)
...
![](G:\JavaLearning2023\project2024\images\image316.png)
...
![](G:\JavaLearning2023\project2024\images\QQ截图20240325211736.png)
...
![](G:\JavaLearning2023\project2024\images\QQ截图20240329105337.png)
...
![](G:\JavaLearning2023\project2024\images\QQ截图20240329105445.png)
...
![](G:\JavaLearning2023\project2024\images\QQ截图20240329114259.png)![](G:\JavaLearning2023\project2024\images\QQ截图20240329114354.png)
...
- **models**包
  ...
  ![](G:\JavaLearning2023\project2024\images\QQ截图20240329115521.png)

- **AaClient**

  客户端类，主要是三部分：属性、构造器、方法

  ![](G:\JavaLearning2023\project2024\images\QQ截图20240329115857.png)
  ...
  **方法**：调用API的入口方法（不是具体的业务，执行这个方法就会发送请求到对应的主机来执行业务），参数是在models中的Request封装类，返回类型是Response的封装类。里面执行了相对通用的发送请求的方法 internalRequest()，主要是根据不同的API (actionName)来发送请求（后面细讲）。
  ...
  ![](G:\JavaLearning2023\project2024\images\QQ截图20240329125804.png)

- **AaErrorCode**

  定义了不同错误类型的枚举类

  ![](G:\JavaLearning2023\project2024\images\QQ截图20240329130641.png)
...
5. 通用结构
   ...
   ![](G:\JavaLearning2023\project2024\images\QQ截图20240329131824.png)

   - AbstractClient：抽象类，定义了客户端的一些基础结构，其他模块的客户端在此基础上实现

   - Credential：定义了用户调用接口许可的凭证，如密钥ID和密钥。

     ![](G:\JavaLearning2023\project2024\images\QQ截图20240329133815.png)

   - sign：定义前面生成方法，加密算法等

     ![](G:\JavaLearning2023\project2024\images\QQ截图20240329134206.png)
...
![](G:\JavaLearning2023\project2024\images\QQ截图20240329142339.png)

3. **doRequest()**比较简洁，先看

   ![](G:\JavaLearning2023\project2024\images\QQ截图20240329142825.png)
   ...
   **对于<font color='red'>post</font>请求**：
   ...
   ![](G:\JavaLearning2023\project2024\images\QQ截图20240329145129.png)
...
![](G:\JavaLearning2023\project2024\images\QQ截图20240329195657.png)
...
![](G:\JavaLearning2023\project2024\images\QQ截图20240329195350.png)
...
![](G:\JavaLearning2023\project2024\images\6c3ebf00103vd.svg)
...
![](G:\JavaLearning2023\project2024\images\QQ截图20240329104518.png)

![](G:\JavaLearning2023\project2024\images\QQ截图20240329104818.png)

SDK也很类似

![](G:\JavaLearning2023\project2024\images\QQ截图20240329200802.png)
...
![](G:\JavaLearning2023\project2024\images\42fc2d55ccbed47e618eb1f16a94a5e7121354.png)
...
![](G:\JavaLearning2023\project2024\images\a68a0c26f4d404ed8b2745f4ad21687f193061.png)
...
3. 最终将“语料”+“规则”输入代码生成器以完成目标代码的生成。
   ...
   <img src="G:\JavaLearning2023\project2024\images\d98ed501c083ca9b5207c4c052b3abcc340972.png" style="zoom: 50%;" />

> #### **05 API元数据**

**API元数据是代码语料生成的数据源**，其来源于开放平台实现的零编码API网关底层维护的基础配置。开放平台网关基于API元数据配置化的技术，可做到零编码将业务服务的RPC接口转化为HTTP协议的API进行开放。其基本运行结构如下图所示：

![](G:\JavaLearning2023\project2024\images\49245d3c18d8f755dbefdc6478f689bf230136.png)
...
![](G:\JavaLearning2023\project2024\images\e2d3a67d186f36e9c5b24e47b056e2cb504544.png)
...
![](G:\JavaLearning2023\project2024\images\723c582613c49822aeb8f8a6279f7e59636801.png)
...
![](G:\JavaLearning2023\project2024\images\bf5a87af7adc4bc44249c5f003fba930270816.png)
...
5. 在规范请求中 host 放入的是服务终端endpoint，而在后面网关中 host已经被修改为了 网关的地址，可以把endpoint放请求头传过来，但是这样就对外暴露了接口的服务终端，解决办法是根据path和method查数据库找到接口对应的endpoint 。
   ...
   ![](G:\JavaLearning2023\project2024\images\QQ截图20240409191959.png)
...
![](G:\JavaLearning2023\project2024\images\QQ截图20240527211109.png)
...
![](G:\JavaLearning2023\project2024\images\QQ截图20240527211852.png)
...
![](G:\JavaLearning2023\project2024\images\QQ截图20240710141029.png)
...
3. accessToken过期或者被删除后（但RefreshToken还在），并没有续签，而是直接异常，提醒用户重新登录。
   ...
   <img src="G:\JavaLearning2023\project2024\images\QQ截图20240427210107.png" style="zoom: 50%;" /><img src="G:\JavaLearning2023\project2024\images\QQ截图20240427205743.png" style="zoom:50%;" />
...
![](G:\JavaLearning2023\project2024\images\QQ截图20240428214018.png)
...
<img src="G:\JavaLearning2023\project2024\images\QQ截图20240504172003.png" style="zoom:80%;" /><img src="G:\JavaLearning2023\project2024\images\QQ截图20240504172033.png" style="zoom:67%;" />
...
![](G:\JavaLearning2023\project2024\images\QQ截图20240424215901.png)
...
![](G:\JavaLearning2023\project2024\images\c62d13dcf1654c20a31a4e2a9c86b2d6.png)
...
![](G:\JavaLearning2023\project2024\images\QQ截图20240613120433.png)
...
![ ](G:\JavaLearning2023\project2024\images\QQ截图20240613160611.png)
...
![](G:\JavaLearning2023\project2024\images\QQ截图20240619164036.png)
...
![](G:\JavaLearning2023\project2024\images\QQ截图20240618093311.png)

![](G:\JavaLearning2023\project2024\images\QQ截图20240618094520.png)
...
![](G:\JavaLearning2023\project2024\images\QQ截图20240618105514.png)

![](G:\JavaLearning2023\project2024\images\QQ截图20240618095630.png)
...
<img src="G:\JavaLearning2023\project2024\images\QQ截图20240619190811.png" style="zoom:67%;" />

<img src="G:\JavaLearning2023\project2024\images\QQ截图20240619190904.png" style="zoom:67%;" />
...
![](G:\JavaLearning2023\project2024\images\QQ截图20240630161135.png)
...
![](G:\JavaLearning2023\project2024\images\QQ截图20240630155958.png)
