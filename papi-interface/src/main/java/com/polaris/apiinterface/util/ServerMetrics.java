 ...
 * @author polaris
 * @version 1.0
 * ClassName ServerMetricsUtil
 * Package com.polaris.apiinterface.util
 * Description
 * @create 2024-06-28 21:56
 */
@Data
@Slf4j
public class ServerMetrics {
     ...
     */
    public double getDiskIOUsagePercentage() {
     ...
     * @return Disk IO usage percentage.
     */
    public double getNetworkUsagePercentage() {
    ...
    public ServerMetrics (String profile) {
        cpuUsage = getCpuUsagePercentage();
        memoryUsage = getMemoryUsagePercentage();
        if(!profile.equals("dev")){
            diskUsage = getDiskIOUsagePercentage();
            networkUsage = getNetworkUsagePercentage();
        }
    }
